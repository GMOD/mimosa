...
my $role = undef;
my $email = undef;
my $schema = App::Mimosa::Auth::Schema->connect("dbi:SQLite:$Bin/auth.db");
...
app_mimosa_auth_admin.pl - Sets the username and password for the generated authentication database

=head1 SYNOPSIS

app_mimosa_auth_admin.pl -user username -passwd password [-role role]
